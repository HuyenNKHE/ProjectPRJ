...
public class NewFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String uri=req.getServletPath();
          if (uri.endsWith(".jsp")&& !(uri.contains("success_signup.jsp"))&& !(uri.contains("login.jsp"))&&!(uri.contains("profile.jsp")) && !(uri.contains("success_order.jsp"))) {
            res.sendRedirect("home2");
          }
