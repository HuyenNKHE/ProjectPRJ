                                        ...
                                        <div class="d-flex justify-content-between p-md-1">
                                            <div class="d-flex flex-row">
                                                <div class="align-self-center">
                                                    <img src="images/find-product-icon.png" width="45px" height="45px" alt="Products List"/>
                                                </div>
                                                <div>
                                    ...
                                    <div class="d-flex justify-content-between p-md-1">
                                        <div class="d-flex flex-row">
                                            <div class="align-self-center">
                                                <h4>Lowest Price</h4>
                                                <p class="mb-0"></p>
                                                <img src="images/lowest_price.png" width="45px" height="45px" alt="Product Min Price"/>
                                            </div>
                                            <div>
                                            </div>
                                        </div>
                                        <div class="align-self-center">
                                            <img src="${pmin.image}" width="200px" height="200px"/>
                                            <h2>${pmin.name}</h2>
                                            <p>${String.format("%,.2f", pmin.price)} VND</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex justify-content-between p-md-1">
                                        <div class="d-flex flex-row">
                                            <div class="align-self-center">
                                                <h4>Highest Price</h4>
                                                <p class="mb-0"></p>
                                                <img src="images/highest_price.jpg" width="80px" height="80px" alt="Product Max Price"/>
                                            </div>
                                            <div>
                                            </div>
                                        </div>
                                        <div class="align-self-center">
                                            <img src="${pmax.image}" width="200px" height="200px"/>
                                            <h2>${pmax.name}</h2>
                                            <p>${String.format("%,.2f", pmax.price)} VND</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between p-md-1">
                                        <div class="d-flex flex-row">
                                            <div class="align-self-center">
                                                <h2 class="h1 mb-0 me-4">${String.format("%,.2f", sumAllInvoice)} VND</h2>
                                            </div>
                                            <div>
                                        ...
                                        <div class="align-self-center">
                                            <h4>Total Sales</h4>
                                            <p class="mb-0"></p>
                                            <<img src="images/involce.png" width="45" height="45" alt="alt"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
