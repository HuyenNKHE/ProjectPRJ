<%-- 
    ...
    Created on : Oct 23, 2023, 8:45:09 AM
    Author     : admin
--%>
        ...
        <div class="container">
            <div class="table-wrapper">
                    ...
                    <tbody>
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>${String.format("%,.2f", o.price)} VND</td>
                                <td>${o.quantity}</td>
                                <td>
                ...
                <div class="clearfix">
                    ...
                    <c:set var="listP" value="${requestScope.listPP}"/>

                    <c:if test="${list!=null}">
                        <div class="hint-text">Showing <b>${list.size()}</b> out of <b>${listP.size()}</b> entries</div>
                        <ul class="pagination">
            ...
            <a href="home2"><button type="button" class="btn btn-primary">Back to home</button>
            </a>
        </div>
        <!-- Edit Modal HTML -->
