                                            ...
                                            <c:forEach items="${listCart}" var="o">
                                             <c:forEach items="${listProduct}" var="p">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><strong>${String.format("%,.2f", p.price)} VND</strong></td>
                                                    <td class="align-middle"><strong>${p.title}</strong></td>
                                                    <td class="align-middle"><strong>${p.cateID}</strong></td>
                                ...
                                <div class="p-4" >
                                    ...
                                    <c:forEach items="${listCart}" var="o">
                                        <c:forEach items="${listProduct}" var="p">
                                         ...
                                         <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng tiền hàng</strong><strong>${String.format("%,.2f", (p.getPrice() * o.getAmount()))} VND</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Phí vận chuyển</strong><strong>Free ship</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">VAT</strong><strong>10 %</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng thanh toán</strong>
                                            <h5 class="font-weight-bold">${String.format("%,.2f", ( (p.getPrice() * o.getAmount()))+(((p.getPrice() * o.getAmount())) *0.1) )} VND</h5>
                                        </li> 
