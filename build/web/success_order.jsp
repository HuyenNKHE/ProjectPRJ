        ...
        <a href="/" class="avatar avatar100 ml-auto mr-auto bg-success text-success-light rounded-circle"> 
            <i class="fa fa-check"></i> </a><div class="row"><div class="col-md-12"><div class="clearfix pt-3">
                        <p> CHECK OUT SUCCESSFUL!!!
                            <br>ARINGO BARKERY HAS BEEN SENT TO YOUR MAIL !
                            <br>Please, open your mail to check your order detail immediately.
                            <br>If the email doesn't appear shortly, please be sure to check your spam
                        </p>
                        <p><a class="btn btn-info btn-fill" href=""></a></p>
                        <div class="text-center pt-2">
                            <a href="home2" class="pb-1 b-b text-muted"> Click Here To Continue Shopping </a>
                        </div></div></div></div></div>
